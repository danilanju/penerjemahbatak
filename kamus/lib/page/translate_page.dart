          ...
          children: [
            Column(
              children: [
                Container(
                  width:
                      double.infinity, // Atur lebar Container sesuai kebutuhan
                ...
                MaterialButton(
                  ...
                  onPressed: () {
                    ...
                    Uri url =
                        Uri.parse('http://technologysupport.id/api/get_kamus');
                    http.post(url, body: {'kunci': inputText}).then((response) {
